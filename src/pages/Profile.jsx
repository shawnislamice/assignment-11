...
const Profile = () => {
  ...
  const {
    ...
    queryFn: () => getData(),
    queryKey:['bookings-profile',user]
  });
  const getData = async () => {
  ...
  return (
    <div className="mx-auto my-10 flex max-w-[350px] flex-col items-center justify-center space-y-4 rounded-xl bg-white p-8 font-sans shadow-lg ">
      ...
      <div className="flex w-full justify-between py-2">
        <div className="space-y-1 text-center">
          <p className="text-gray-500 dark:text-white/70">Booked</p>
          <p className="font-mono text-xl text-gray-700 dark:text-white/50">
            {bookedBookings.length}
          </p>
        </div>
        <div className="space-y-1 text-center">
          <p className="text-gray-500 dark:text-white/70">Pending</p>
          <p className="font-mono text-xl text-gray-700 dark:text-white/50">
            {pendingBookings.length}
          </p>
        </div>
        <div className="space-y-1 text-center ">
          <p className="text-gray-500 dark:text-white/70">Cenceled</p>
          <p className="font-mono text-xl text-gray-700 dark:text-white/50">
      ...
      <Link to="/updateprofile">
        <button className="w-full px-6 rounded-full py-3 font-medium text-gray-400 shadow-[0px_0px_10px_#E2DADA] duration-500 hover:scale-95  hover:bg-[#0095FF] hover:text-white hover:shadow-xl dark:shadow-[0px_2px_8px_0px_rgba(0,0,0,0.8)]">
          Update Profile
        </button>
      </Link>
    </div>
